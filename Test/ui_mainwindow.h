...
**
** Created: Tue Mar 11 11:56:00 2014
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setGeometry(QRect(50, 220, 98, 27));
        radioButton = new QRadioButton(centralWidget);
        radioButton->setObjectName(QString::fromUtf8("radioButton"));
        radioButton->setGeometry(QRect(40, 180, 116, 22));
        checkBox = new QCheckBox(centralWidget);
        checkBox->setObjectName(QString::fromUtf8("checkBox"));
        checkBox->setGeometry(QRect(50, 140, 97, 22));
        testline = new QLineEdit(centralWidget);
        testline->setObjectName(QString::fromUtf8("testline"));
        testline->setGeometry(QRect(50, 30, 113, 27));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setText(QApplication::translate("MainWindow", "Hello Woirld", 0, QApplication::UnicodeUTF8));
