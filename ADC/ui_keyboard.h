...
**
** Created: Fri May 2 13:07:21 2014
...
"background-color: rgb(255, 255, 255);"));
        ...
        gridLayout->addWidget(Buttonq, 2, 0, 1, 1);
        ...
        gridLayout->addWidget(Buttonp, 2, 9, 1, 1);
        ...
        gridLayout->addWidget(Buttonl, 4, 8, 1, 1);
        ...
        gridLayout->addWidget(Buttonx, 5, 2, 1, 1);
        ...
        gridLayout->addWidget(Buttonr, 2, 3, 1, 1);
        ...
        gridLayout->addWidget(Buttonj, 4, 6, 1, 1);
        ...
        gridLayout->addWidget(Buttond, 4, 2, 1, 1);
        ...
        gridLayout->addWidget(Buttong, 4, 4, 1, 1);
        ...
        gridLayout->addWidget(Buttony, 2, 5, 1, 1);
        ...
        gridLayout->addWidget(Buttonb, 5, 5, 1, 1);
        ...
        gridLayout->addWidget(Buttono, 2, 8, 1, 1);
        ...
        gridLayout->addWidget(Buttonf, 4, 3, 1, 1);
        ...
        gridLayout->addWidget(Buttons, 4, 1, 1, 1);
        ...
        gridLayout->addWidget(Buttonk, 4, 7, 1, 1);
        ...
        gridLayout->addWidget(shift, 5, 0, 2, 1);
        ...
        gridLayout->addWidget(Buttonv, 5, 4, 1, 1);
        ...
        gridLayout->addWidget(Buttone, 2, 2, 1, 1);
        ...
        gridLayout->addWidget(Buttonh, 4, 5, 1, 1);
        ...
        gridLayout->addWidget(Buttoni, 2, 7, 1, 1);
        ...
        gridLayout->addWidget(Buttonz, 5, 1, 1, 1);
        ...
        gridLayout->addWidget(char_2, 5, 8, 2, 1);
        ...
        enterButton->setMinimumSize(QSize(58, 0));
        enterButton->setMaximumSize(QSize(1000, 1000));

        gridLayout->addWidget(enterButton, 4, 9, 3, 1);
        ...
        gridLayout->addWidget(Buttonn, 5, 6, 1, 1);
        ...
        gridLayout->addWidget(Buttonm, 5, 7, 1, 1);
        ...
        gridLayout->addWidget(Buttonw, 2, 1, 1, 1);
        ...
        gridLayout->addWidget(Buttonu, 2, 6, 1, 1);
        ...
        gridLayout->addWidget(Buttonc, 5, 3, 1, 1);
        ...
        gridLayout->addWidget(Buttona, 4, 0, 1, 1);
    ...
    {
        backButton->setText(QApplication::translate("Keyboard", "Back", 0, QApplication::UnicodeUTF8));
        clear->setText(QApplication::translate("Keyboard", "Clear", 0, QApplication::UnicodeUTF8));
